...
~~~sh
# getting the code
git clone git@github.com:nko5/pizzarocket.git && cd ./pizzarocket/
...
# deploying to Modulus (to http://pizzarocket.2015.nodeknockout.com/)
modulus deploy
...
~~~html
<iframe src="http://nodeknockout.com/iframe/pizzarocket" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
